...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<NetCoreAnalyzers.SampleSyntaxAnalyzer,
        NetCoreAnalyzers.SampleCodeFixProvider>;

namespace NetCoreAnalyzers.Tests;
