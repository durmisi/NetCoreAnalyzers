...
### NetCoreAnalyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [NetCoreAnalyzers.Sample.csproj](../NetCoreAnalyzers.Sample/NetCoreAnalyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### NetCoreAnalyzers.Tests
